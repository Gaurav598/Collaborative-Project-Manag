...
export default function ProjectSettings({ project }) {
    ...
    // Safely format a date value that may be a string or Date object
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            dispatch(updateWorkspace({ ...project, ...formData }));
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-4 grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                             ...
                             <input type="date" value={safeFormatDate(formData.start_date)} onChange={(e) => setFormData({ ...formData, start_date: e.target.value })} className={inputClasses} />
                         </div>
                         <div className="space-y-2">
                             <label className={labelClasses}>End Date</label>
                             <input type="date" value={safeFormatDate(formData.end_date)} onChange={(e) => setFormData({ ...formData, end_date: e.target.value })} className={inputClasses} />
                         </div>
                    </div>
